...
<<<<<<<< HEAD:animal-adoption-api/front/src/pages/sign-in/Registration.jsx
      const url = "https://localhost:44387/api/v1/Auth/register-user";
========
    const url = "http://localhost:5078/api/v1/Auth/register-user";
>>>>>>>> de0b3ed65e0fbb34d43e3c584c11abb4ee55063c:animal-adoption-api/front/src/pages/sign-in/Register.jsx
    axios
      .post(url, data)
      .then((result) => {
        alert(result.data);
